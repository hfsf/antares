...
class ExposedVariableError(Exception):
    ...
    def __str__(self):
        ...
        msg = (
            "Non-exposed variable declaration in the output model(1) \n %s \n and/or input model(2) \n %s. \n The declared output variable name is %s, and the input variable name is %s."
            % (
...
class AbsentRequiredObjectError(Exception):
    ...
    def __str__(self):
        ...
        msg = (
            "Absent required object error. A %s was expected, but no one was supplied."
            % (self.expected_type)
        )
...
class UnexpectedValueError(Exception):
    ...
    def __str__(self):
        ...
        msg = (
            "Unexpected value error. A %s was expected, but one divergent type was supplied."
            % (self.expected_type)
        )
...
class UnitOperationError(Exception):
    ...
    def __str__(self):
        ...
        msg = "UnitOp object was defined for port {} with lenght {}, but a element of size {} was supplied.".format(
            self.port, self.n, len(self.elem)
        )
