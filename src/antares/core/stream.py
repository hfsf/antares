...
class MaterialStream(Model):
    ...
    Assumes standard vapor/ideal fluid behavior. Delegates properties to PropertyPackage.
    """
    ...
    def DeclareVariables(self):
        ...
        self.H_molar = self.createVariable("H_molar", "J/mol", description="Molar Enthalpy", value=0.0, exposure_type="algebraic")
...
class EnergyStream(Model):
    ...
    def DeclareVariables(self):
        if self.stream_type == "heat":
            self.Q = self.createVariable("Q", "W", value=0.0, exposure_type="algebraic")
